...
are required. By clicking 'Save' button on the right bottom corner of the form you'll send the data to database. This action will trigger the re-rendering of block which contains all created trips.
